...
export class Init1686952398256 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "subscriber" ("id" SERIAL PRIMARY KEY, "did" varchar NOT NULL, "indexedAt" timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP, "lastUpdated" timestamp NOT NULL DEFAULT (), "expiresAt" date)`);
